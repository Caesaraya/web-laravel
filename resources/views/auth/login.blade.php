            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:hover:text-indigo-400">Forgot
                                password?</a>
                        </div>
                    </div>
                    <div class="mt-2">
                ...
                <div class="flex items-center">
                    ...
                    <label for="remember"
                        class="ml-2 block text-sm text-gray-900 dark:text-white">Remember
                        me</label>
                </div>
