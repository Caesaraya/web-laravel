                ...
                @auth
                    <el-dropdown class="relative ml-3">
                        ...
                        <el-menu anchor="bottom end" popover class="w-48 bg-gray-800 rounded-md">
                            <a href="/" class="block px-4 py-2 text-sm text-gray-300">Dashboard</a>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="{{ route('home') }}" aria-current="page"
          class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white dark:bg-gray-950/50">Home</a>
        <a href="{{ route('profil') }}"
          class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Profil</a>
        <a href="{{ route('kontak') }}"
          class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Kontak</a>
      </div>
